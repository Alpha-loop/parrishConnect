          ...
          <View>
                ...
                <View style={{ backgroundColor: COLORS.primary, height: '100%', marginTop: 20 }}>
                    <View style={{ width: '70%', alignSelf: 'center' }}>
                        <Text style={{ fontFamily: Fonts.black, fontSize: 23, textAlign: 'center', color: 'orange' }}>Daily Devotion</Text>
                        <Text style={{ fontFamily: Fonts.black, fontSize: 23, textAlign: 'center', color: COLORS.white }}>for Your Spiritual Growth</Text>
                    </View>
